...
WEB_PASSWORD = os.environ.get("WEB_PASSWORD", "change-me")

# Two-box config (simplest + safest to start)
BOX1_ID = os.environ.get("BOX1_ID", "box_a")
BOX1_TOKEN = os.environ.get("BOX1_TOKEN", "token_a")
BOX2_ID = os.environ.get("BOX2_ID", "box_b")
BOX2_TOKEN = os.environ.get("BOX2_TOKEN", "token_b")
